...
<body class="emp_body">
	...
	<form action="${pageContext.request.contextPath}/dep/insertDep"
		method="post">
		<table width="88%" border="0" class="emp_table" style="width: 80%;">
			<tr>
				...
				<c:if test="${dep.depId.equals(null) == false}" var="testName">
				<td>更改前<input type="text" name="depNamebefore" value="${dep.depName}"></input></td>
					<td><input type="text" name="depId" value="${dep.depId}" /></td>
				</c:if>
			</tr>
		</table>
	</form>
	...
	<%-- 
	<c:if test="${!testName}">
		<form action="${pageContext.request.contextPath}/dep/updateDep/${name}"
			method="post">
			<table width="88%" border="0" class="emp_table" style="width: 80%;">
				<tr>
					<td>部门名称：</td>
					<td><input type="text" name="depNamebefore" value="${name}" />
						<td>更改后<input type="text" name="depName" /></td></td>
				</tr>
			</table>
		</form>
