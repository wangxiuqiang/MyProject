...
<div class="dtree">
	<script type="text/javascript">
		...
		d.add('010102','0101','报名学生管理','${pageContext.request.contextPath}/pages/refer/listRefer.jsp?status=2','','right');
		...
		d.add('0105','01','人力资源部');
		d.add('010501','0105','部门管理','${pageContext.request.contextPath}/dep/selectAllDep','','right');
