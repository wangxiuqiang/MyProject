...
const img_arr = [require('./res/clothes/clothes1.jpg'), require('./res/clothes/clothes2.jpg'), require('./res/clothes/clothes3.jpg'),
 ...
 */
export default class ClothesShow extends Component {
    constructor(props) {
        super(props);
