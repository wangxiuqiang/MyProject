 ...
 * 从json文件中获取数据
 */
var data = require('./Computer.json');
/**
...
const img_arr = [require('./res/computerImage/computer1.jpg'), require('./res/computerImage/computer2.jpg'), require('./res/computerImage/computer3.jpg'),
 ...
 */
export default class ComputerShow extends Component {
    constructor(props) {
        super(props);
