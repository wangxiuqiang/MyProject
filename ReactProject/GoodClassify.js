...
export default class GoodClassify extends Component {
                    ...
                    <View style={[{ justifyContent: 'center', alignItems: 'center' }]}>
                        <TouchableOpacity
                            ...
                            <Image style={[styles.imageStyle]}
                                source={require('./res/classifyImage/food.jpg')}>
                            </Image>
                            <Text>  零食</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={[{ justifyContent: 'center', alignItems: 'center' }]}>
                        <TouchableOpacity
                            ...
                            <Image style={[styles.imageStyle, { marginLeft: 50 }]}
                                source={require('./res/classifyImage/clothClassify_icon.jpg')}>
                            </Image>
                            <Text style={[{ marginLeft: 50 }]}>  衣服</Text>
                        </TouchableOpacity>
                    </View>
                </View>
                <View style={{ position: 'relative', left: 56, top: 150, flexDirection: 'row' }}>
                    ...
                    <View style={[{ justifyContent: 'center', alignItems: 'center' }]}>
                        <TouchableOpacity
                            ...
                            <Image style={[styles.imageStyle]}
                                source={require('./res/classifyImage/computerClassify_icon.jpg')}>
                            </Image>
                            <Text>  电脑</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={[{ justifyContent: 'center', alignItems: 'center' }]}>
                        <TouchableOpacity
                            ...
                            <Image style={[styles.imageStyle, { marginLeft: 50 }]}
                                source={require('./res/classifyImage/shoeClassify_icon.jpg')}>
                            </Image>
    ...
    toolBaronActionSelected(position) {
        ...
        if (position === 0) {
            this._navigateClassify(GoodClassify);
        }
        if (position === 2) {
