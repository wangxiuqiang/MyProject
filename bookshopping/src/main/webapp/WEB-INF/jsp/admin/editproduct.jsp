					...
					<div class="ibox-content">
						<form method="post" class="form-horizontal" id="addGoodsForm"
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input id="goodsName" name="name" type="text" value="${product.name}"
							...
							<div class="form-group">
								...
								<!-- 传入id -->
								<!-- 隐藏域 -->
								<input id="id" hidden="true" name ="id" value="${product.id}">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
...
// 	}
	...
	$(function () {
		$("#selCategory").val("${product.category}");
