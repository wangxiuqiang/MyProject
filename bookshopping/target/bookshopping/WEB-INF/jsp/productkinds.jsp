        ...
        <div class="main">
            <div class="menubox">
                ...
                <div class="menu">
                    <ul>
                        ...
                        <li class="aa">主页</li>
                        <li class="aa"><a href="${pageContext.request.contextPath}/showCart">我的订单</a></li>
                        <li class="aa"><a href="${pageContext.request.contextPath}/showCreateOrder">我的购物车</a></li>
                        <li class="aa">下载榜单</li>
                        <li class="aa">关于我们</li>
                        <li class="aa">联系方式</li>
                    </ul>
            ...
            <div class="tuijian">
                ...
                <div style="float: none; margin-top: 20px;">
                     <a href="${pageContext.request.contextPath}/showproductkinds?type=${type}&page=${pageBean.page - 1}"><button type="button" id="up" style="float: left;background:#87520E;line-height:30px;color:white;border:0;padding:3px 7px;font-size:15px;cursor:pointer;">上一页</button></a>
                    <a href="${pageContext.request.contextPath}/showproductkinds?type=${type}&page=${pageBean.page + 1}"> <button type="button" id="down" style="float: right;background:#87520E;line-height:30px;color:white;border:0;padding:3px 7px;font-size:15px;cursor:pointer;">下一页</button></a>
                </div>
